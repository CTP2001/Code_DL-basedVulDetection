...
def dealfile_nvd(folder_path,diff_path):
    for folder in os.listdir(folder_path):
        ...
        with open('./vul_context.pkl','wb') as f:
            pickle.dump(vulline_dict,f)
        f.close()
...
if __name__ == "__main__":
    ...
    data_source1 = '/home/ubuntu/SySeVR/Data/NVD/NVD/'
    diff_path = '/home/ubuntu/SySeVR/Data/NVD_diff/'
    dealfunc_nvd(data_source1,diff_path)
    
    data_source2 = '/home/ubuntu/SySeVR/Data/NVD/NVD'
