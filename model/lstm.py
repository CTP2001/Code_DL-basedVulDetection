...
def main(traindataSet_path, testdataSet_path, weightpath, resultpath, batch_size, maxlen, vector_dim, layers, dropout):
    ...
    f = open("TP_index_lstm.pkl",'wb')
    pickle.dump(result[1], f)
    f.close()

    f_TP = open("./result_analyze/LSTM/TP_filenames.txt","a+")
    f_TP.write(tname+'\n')
    ...
    f_FP = open("./result_analyze/LSTM/FP_filenames.txt","a+")
    f_FP.write(tname+'\n')
    ...
    f_FN = open("./result_analyze/LSTM/FN_filenames.txt","a+")
    f_FN.write(tname+'\n')
...
if __name__ == "__main__":
    ...
    weightPath = './model/LSTM'
    resultPath = "./result/LSTM/LSTM"
