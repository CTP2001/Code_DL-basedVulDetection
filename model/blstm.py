...
def main(traindataSet_path, testdataSet_path, weightpath, resultpath, batch_size, maxlen, vector_dim, layers, dropout):
    ...
    f_TP = open("./result_analyze/BLSTM/TP_filenames.txt","a+")
    f_TP.write(tname+'\n')
    ...
    f_FP = open("./result_analyze/BLSTM/FP_filenames.txt","a+")
    f_FP.write(tname+'\n')
    ...
    f_FN = open("./result_analyze/BLSTM/FN_filenames.txt","a+")
    f_FN.write(tname+'\n')
...
if __name__ == "__main__":
    ...
    weightPath = './model/BLSTM'
    resultPath = "./result/BLSTM/BLSTM"
